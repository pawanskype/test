            ...
            <p>Default Global Option will apply the sections to all locations which will be empty. However you can overide any section by checking the overide option.</p>
			    ...
			    <?php if(isset($_SESSION['msg_error'])) { ?>
					...
					<section class="content-box">
						...
						<?php } ?>
							...
							<div class="form-group">
								...
								<input type="text" id="datepicker" name="date" class="form-control" value="<?php echo date('d-m-Y', strtotime($holidayfetch_global['holiday_date'])); ?>" placeholder="Enter Date (Format: mm-dd-yyyy)" />
							</div>
					...
					<?php } ?>
						...
						<div class="form-group">
							<label class="control-label" for="datepicker">You can close all locations on a specific holiday by selecting date below.</label>
							<input type="text" id="datepicker" name="date" class="form-control" placeholder="Enter Date (Format: mm-dd-yyyy)" />
						</div>
							...
							<div class="form-builder-in">
								...
								<?php if(count(array_filter($forminput)) > 0) { ?>
									<div class="row">
										<div class="form-group">  
											<div class="col-sm-4">
												<select class="form-control" name="forminput[]" id="select_tag">
											...
											<div class="col-sm-4">
												<div class="enter_plo">
													<textarea class="form-control select_text" placeholder=" Placeholder/Label/Options" name="formplaceholder[]"><?php echo $contactform[$a]['formplaceholder']; ?></textarea>
												</div>
											</div>
											<div class="col-sm-2">
					...
					<section class="content-box">
				<form id="global-options" method="POST" action="inc/submit.php" enctype="multipart/form-data">
					<?php if($role == 'superadmin') { ?>
						<input type="hidden" name="adminid" value="<?php echo $_GET['adminid']; ?>" />
					<?php } ?>
					<section class="content-box">
					...
					<section class="content-box">
						<label for="overideemail">Override contact form email. <input type="checkbox" id="overideemail" name="overideemail" <?php echo ($emailmessageidoveride_global == 'on' ? 'checked' : '');?> /></label>
						<div class="box-title">Contact Form</div>
						<div class="form-group">
							<label for="emailmesageid">Email Messages Will Be Sent To <span class="required-star">*</span></label>
							<input type="text" class="form-control" id="emailmesageid" name="emailmesageid" placeholder="Enter the email you want your messages sent to" value="<?php echo $emailmessageid_global; ?>" />
						</div>
					</section>
					<section class="content-box">
					...
					<div class="submit-section">
						<div class="add-location-btn"><input type="submit" name="addglobaloptions" id="addGlobal" class="btn btn-primary" value="Update Options" /></div>
					</div>
				</form>
				</section>
				</section>
