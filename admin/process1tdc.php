	...
	// dump json into a file on server 
			 $fileName = 'jsondump_tdc';
				 ...
				 if (file_put_contents($fileName,'') !== false)
				 {
					...
					mysqli_query($conn,"INSERT INTO jsondump_tdc(filename,created) VALUES('".mysqli_real_escape_string($conn, $path)."','$current_time')");
					
				 }else
				 {
					  
					mysqli_query($conn, "INSERT into r1_logs_tdc(message,created_at) VALUES ('process1BF Zipcodesnew backup could not be uploaded','$current_time')"); 
				 }
