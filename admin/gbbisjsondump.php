	   ...
	   <?php include 'sidebar.php'; ?>
        <div class="col-md-9">
          <div class="content-wrapper">
            <h1 class="page-title" style="float:left;width:35%;">JSON Dump Download</h1>
...
<script>
  $(document).ready(function(){
     ...
     $("#process2").click(function(e){
        ...
        $.ajax({
					   type: "POST",
					   url: "https://store-locator.restoration1.com/admin/process2.php",
					   dataType: 'json',
					   success: function(data) {
	  ...
	  $(".reprocess").click(function(e){
		...
		e.preventDefault();
		$("#msg").html("");
		$(".loader").addClass('parentDisable'); 
                                         $(".loader").addClass('loader_style');
                                         $(".loader").show();proc
