	   ...
	   <?php include 'sidebar.php'; ?>
        <div class="col-md-9">
          <div class="content-wrapper">
            <h1 class="page-title" style="float:left;width:35%;">TDC JSON Dump Download</h1>
			...
			<div class="btn-container sitemapexport">						
						...
						<p>Upload Latest GbBIS data for TDC</p>
...
<script>
  $(document).ready(function(){
     ...
     $("#process2").click(function(e){
        ...
        $.ajax({
					   type: "POST",
					   url: "https://store-locator.restoration1.com/admin/process2tdc.php",
					   dataType: 'json',
					   success: function(data) {
